        ...
        <button onClick={openModal} className='bg-white w-full rounded-lg p-4 flex flex-col gap-4 border border-[#EBEBEB]'>
            ...
            <div className='flex gap-2 items-center'>
                <div className="relative overflow-hidden bg-gray-100 rounded-full dark:bg-gray-600">
                    <img src={imgProfile} className="absolute md:w-5 md:h-5 w-[18px] h-[18px]" alt="Konnect Logo" />
                </div>
                <p className='md:text-[10px] text-[8px] text-[#B0B0B0]'>{author}</p>
            </div>
            ...
            <div className='lg:flex lg:items-center gap-9 lg:mt-0 md:mt-0 mt-1'>
                ...
                <div className='lg:mt-0 md:mt-0 mt-5'>
                    <p className='text-[#888888] text-start text-[8px] md:text-xs'>{textBudget}</p>
                    <p className='font-semibold text-sm md:text-xl text-[#1A1A1A] text-start'>Rp {budget ? (parseInt(budget).toLocaleString()).replaceAll(',', ".") : null}</p>
                </div>
            ...
            <div className='w-full'>
                <div className='flex items-center justify-between w-full'>
                    <div className='flex gap-1 items-center'>
                        <p className='md:text-base text-sm text-black font-medium'>{jml_tender}</p>
                        <p className='md:text-sm text-[10px] text-black'>{satuan}</p>
                    </div>
                    <p className='md:text-sm text-[8px] text-dark-5 '>Target {jml_target} {satuan}</p>
                </div>
            ...
            <div className='flex gap-1 justify-end w-full'>
                ...
                <div className='flex items-center gap-2'>
                    <svg width="15" height="14" viewBox="0 0 15 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M7.49352 0.999512C4.27352 0.999512 1.66602 3.61285 1.66602 6.83285C1.66602 10.0528 4.27352 12.6662 7.49352 12.6662C10.7193 12.6662 13.3327 10.0528 13.3327 6.83285C13.3327 3.61285 10.7193 0.999512 7.49352 0.999512ZM7.49935 11.4995C4.92102 11.4995 2.83268 9.41118 2.83268 6.83285C2.83268 4.25451 4.92102 2.16618 7.49935 2.16618C10.0777 2.16618 12.166 4.25451 12.166 6.83285C12.166 9.41118 10.0777 11.4995 7.49935 11.4995ZM7.79102 3.91618H6.91602V7.41618L9.97852 9.25368L10.416 8.53618L7.79102 6.97868V3.91618Z" fill="#C1121F" />
                    </svg>
                    <p className='text-[#C1121F] text-[10px]'>{sisa_hari} hari lagi</p>
                </div>
            </div>
        </button>
    )
