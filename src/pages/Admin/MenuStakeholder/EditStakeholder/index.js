...
const EditStakeholder = () => {
  ...
  // console.log(response.data.data.company.legal_documents)
  const getDetail = async () => {
    try {
      const response = await Api.getCompany(localStorage.getItem('token-hub'), params.state.id);
    //   Toggle Input Radio
      response.data.legal_documents.forEach((doc) => {
        if (doc.path !== null) {
          setDocument('Ya');
        }
      });
        ...
        >
          ...
          <div className='flex flex-wrap items-center gap-3 mb-[30px] pt-[120px]'>
            ...
            <img
              ...
              alt=''
            />
            <button className='text-[#737373] text-sm font-[500] hover:text-[#00CDB4]'>Edit Stakeholder</button>
          </div>
          {/* Section 1 */}
            ...
            <div className='w-full'>
              ...
              <div className='w-full mb-[20px]'>
                ...
                <input
                  ...
                  className='rounded-[12px] outline-none border border-[#E3E8F1] w-full px-[20px] py-[15px] text-[#A8A8A8] text-sm font-[500] bg-[#F9FBFC] appearance-none'
              ...
              {/* <div className='w-full mb-[20px]'>
                            <h1 className='text-[#2E3A44] font-[500] mb-[10px] text-base'>Password</h1>
              ...
              <div className='mb-[20px] bg-[#CBD5E1] py-[20px] px-[10px] w-full flex flex-col md:flex-row flex-wrap items-center gap-[20px] rounded-[12px]'>
                ...
                <div className='w-full md:w-[180px]'>
                  ...
                  <input
                    ...
                    className='rounded-[12px] outline-none border border-[#E3E8F1] w-full md:w-[180px] px-[20px] py-[15px] text-[#A8A8A8] text-sm font-[500] bg-[#F9FBFC] appearance-none'
                    required
                  />
                </div>
              </div>
