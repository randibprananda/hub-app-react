...
const LayananEventOrganizer = () => {
    ...
    const [eoSpesifikasiLayanan, setEoSpesifikasiLayanan] = useState();
    ...
    const AddLayananEo = async () => {
        ...
        if (error.length > 0) {
            ...
            for (let i = 0; i < images.length; i++) {
                formData.append("eo_images", images[i]);
            }

            formData.append("eo_name", eoName);
            formData.append("eo_description", eoDescription);
            formData.append("eo_spesification", eoSpesifikasiLayanan);
            ...
            for (let i = 0; i < inputFields.length; i++) {
                ...
                // if(inputFields[i].package_price_type === 'RANGE') {
                //     formData.append("package_price", inputFields[i].package_price + ' ' + '-' + ' ' + opsiRangeValue);
                // } else if(inputFields[i].package_price_type === 'FIXED') {
                //     formData.append("package_price", inputFields[i].package_price.join(', '));
                // }
            ...
            try {
                await Api.postEo(localStorage.getItem("token-hub"), formData).then(async (response) => {
                    ...
                    <div className='flex lg:flex-row flex-col gap-[30px] mt-[30px]'>
                        <div className='md:px-4 md:py-12 rounded-[12px] bg-white px-7 py-5 h-max'>
                            <div className='flex items-center gap-[20px] relative'>
                                <div className={`h-[50px] w-[50px] flex justify-center items-center rounded-full flex-shrink-0 ${stepp === 2 ? 'bg-primary' : 'bg-[#00CDB433]'}  `}>
                                    <h1 className='text-primary font-semibold text-[18px]'>{stepp === 2 ? <span><img src={IconCheckWhite} alt='' /></span> : '1'}</h1>
                                </div>
                                <div>
                                    <h1 className={`text-[#212121] text-sm md:text-base  ${stepp == 2 ? 'font-bold' : 'font-[500]'}`}>Informasi Layanan </h1>
                                    ...
                                    <div className='flex flex-col'>
                                        ...
                                        <div className='flex flex-col gap-[20px] mb-[52px]'>
                                            <div>
                                                ...
                                                <input type="text" id="first_name" className="mt-[10px] rounded-[12px] outline-none border border-outline-2 w-full md:px-4 md:py-4 bg-white px-[10px] py-[10px] text-fill md:text-sm text-xs font-[500]" placeholder="Ex : Starter" onChange={(e) => setEoName(e.target.value)} required />
                                            </div>
                                            <div>
                                                <h1 className='md:text-sm text-xs text-dark-5 font-medium'>Deskripsi Layanan <span className='text-red-700'>*</span></h1>
                                                <textarea onChange={(e) => setEoDescription(e.target.value)} id="message" rows="2" className="rounded-[12px] outline-none border border-outline-2 w-full md:px-4 md:py-4  bg-white px-[10px] py-[10px] text-fill md:text-sm text-xs font-[500]" placeholder="Jelaskan apa yang akan client dapat pada Layanan ini"></textarea>
                                            ...
                                            <div>
                                                ...
                                                <textarea onChange={(e) => setEoSpesifikasiLayanan(e.target.value)} rows="2" className="rounded-[12px] outline-none border border-outline-2 w-full md:px-4 md:py-4 bg-white px-[10px] py-[10px] text-fill md:text-sm text-xs font-[500]" placeholder="Tuliskan lebih detail spesifikasi dari layanan anda "></textarea>
                                                <div className='flex justify-between'>
                                                    <h1 className='md:text-xs text-[8px] text-black-6 font-bold'>Minimal 12 karakter</h1>
                                                    <h1 className='md:text-xs text-[8px] text-black-6 font-bold'>0/1200</h1>
                                                </div>
                                        ...
                                        <div className='flex justify-end items-end space-x-4'>
                                            ...
                                            <button
                                                onClick={() => {
                                                    !eoName || !eoDescription || !eoSpesifikasiLayanan || !images.length ?
                            ...
                            {stepp === 2 &&
                                <div className='flex flex-col'>
                                            ...
                                            return (
                                                <div key={index}>
                                                    ...
                                                    <div className='w-full p-5 bg-light rounded-[12px]'>
                                                        ...
                                                        <div className='space-y-[10px] mb-[10px]'>
                                                            <h1 className='text-[#2E3A44] text-sm font-[500] mb-[10px]'>Ketersediaan tanggal booking<span className='text-[#C1121F] ml-[10px]'>*</span></h1>
                                                        ...
                                                        {/* <div className='space-y-[10px] md:col-span-4 mb-[10px]'>
                                                            ...
                                                            <select value={input.package_price_type} name='package_price_type' onChange={(e) => handleFormChange(index, e)} className='rounded-[12px] outline-none border border-outline-2 w-full appearance-none md:px-4 md:py-4 bg-white px-[10px] py-[10px] relative text-fill md:text-sm text-xs font-[500]'>
                                                        ...
                                                        <div className='md:grid md:grid-cols-12 mb-[10px] gap-[20px]'>
                                                            <div className='w-full md:col-span-4'>
                                                                ...
                                                                <input type='number' value={input.package_price} name='package_price' onChange={(e) => handleFormChange(index, e)} className='rounded-[12px] outline-none border border-outline-2 w-full md:px-4 md:py-4 bg-white px-[10px] py-[10px] text-fill md:text-sm text-xs font-[500]' placeholder='Rp.' required />
                                                            </div>
                                    ...
                                    <div className='flex justify-end items-end space-x-4'>
                                        ...
                                        <button onClick={AddLayananEo} className='h-auto md:py-3 md:px-6 py-2 px-5 text-sm rounded-md bg-cherry text-white flex items-center justify-center font-[500]'>
                                            {/* Simpan */}
                                            {isLoading ?
...
export default LayananEventOrganizer