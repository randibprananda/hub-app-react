...
const CompanyProfileStakeholder = () => {
      ...
      <div className='md:px-[75px] px-[36px] pt-[120px] pb-[10px] md:pt-[140px] md:pb-[30px]'>
        ...
        <div className='mt-[30px] flex items-center'>
          <img
            src={
              !image
                ? imageHandle(companyLogo) === `${UrlApi}`
                  ? LogoDefault
                  : imageHandle(companyLogo)
                : image
            }
          ...
          <div className='bg-[#2D014B] h-[130px] w-full rounded-r-[20px] px-[32px] py-[28px] flex flex-col justify-center gap-3'>
            <h1 className='text-white text-base md:text-[28px] font-bold'>
              {!company.name ? 'Konect-Hub' : company.name}
            </h1>
                      ...
                      <div className='flex flex-wrap gap-2 mt-2'>
                        <div className='py-[6px] px-[20px] flex gap-2 items-center rounded-full bg-[#EDEDED]'>
                          <h1 className='text-[10px] text-[#00CDB4]'>
                            {!documentNIB ? 'NIB Dokumen' : `${documentNIB.type} telah diuploud`}
                          </h1>
                          {documentNIB && (
                  ...
                  <div className='mb-[20px] flex items-center gap-[11px]'>
                    ...
                    <div>
                      ...
                      <div className='flex flex-wrap gap-2 mt-2'>
                        <div className='py-[6px] px-[20px] flex gap-2 items-center rounded-full bg-[#EDEDED]'>
                          <h1 className='text-[10px] text-[#00CDB4]'>
                            {!documentSIUP ? 'SIUP Dokumen' : `${documentSIUP.type} telah diuploud`}
                          </h1>
                          {documentSIUP && (
                  ...
                  <div className='mb-[20px] flex items-center gap-[11px]'>
                    ...
                    <div>
                      ...
                      <div className='flex flex-wrap gap-2 mt-2'>
                        <div className='py-[6px] px-[20px] flex gap-2 items-center rounded-full bg-[#EDEDED]'>
                          <h1 className='text-[10px] text-[#00CDB4]'>
                            {!documentIUMK ? 'IUMK Dokumen' : `${documentIUMK.type} telah diuploud`}
                          </h1>
                          {documentIUMK && (
                  ...
                  <div className='mb-[20px] flex items-center gap-[11px]'>
                    ...
                    <div>
                      ...
                      <div className='flex flex-wrap gap-2 mt-2'>
                        <div className='py-[6px] px-[20px] flex gap-2 items-center rounded-full bg-[#EDEDED]'>
                          <h1 className='text-[10px] text-[#00CDB4]'>
                            {!documentIUI ? 'IUI Dokumen' : `${documentIUI.type} telah diuploud`}
                          </h1>
                          {documentIUI && (
                            <button onClick={() => setDocumentIUI('')}>
                              <svg
                  ...
                  <div className='mb-[20px] flex items-center gap-[11px]'>
                    ...
                    <div>
                      ...
                      <div className='flex flex-wrap gap-2 mt-2'>
                        <div className='py-[6px] px-[20px] flex gap-2 items-center rounded-full bg-[#EDEDED]'>
                          <h1 className='text-[10px] text-[#00CDB4]'>
                            {!documentOther ? 'Other Dokumen' : `${documentOther.type} telah diuploud`}
                          </h1>
                          {documentOther && (
            ...
            <div className='mb-[20px] flex items-center gap-[11px]'>
              ...
              <div>
                ...
                <div className='flex flex-wrap gap-2 mt-2'>
                  <div className='py-[6px] px-[20px] flex gap-2 items-center rounded-full bg-[#EDEDED]'>
                    <h1 className='text-[10px] text-[#00CDB4]'>
                      {!documentSertifikat ? 'Sertifikat Dokumen' : `${documentSertifikat.type} telah diuploud`}
                    </h1>
                    {documentSertifikat && (
...
export default CompanyProfileStakeholder;
