...
import { IconDropdown, IconNext, LogoDefault, Wedding } from '../../../../assets';
...
const DetailVenue = () => {
  ...
  const getData = async () => {
    try {
      ...
      setImage(response.data.data.venue_images[0]);
      setImagesList(response.data.data.venue_images);
      ...
      <div className='md:px-[75px] px-2 pt-[120px] pb-[10px] md:pt-[140px] md:pb-[30px]'>
        ...
        <div>
          <div className='flex items-center gap-3'>
            <button onClick={() => navigate(-1)} className='text-black-k text-xs lg:text-sm font-[500] hover:text-primary'>Profil</button>
            <img src={IconNext} />
          ...
          <div className='mt-[30px] w-full bg-[#ECEEF6] shadow-sm rounded-[12px] p-[22px]'>
            <h1 className='md:text-[30px] text-lg font-medium text-cherry'>{data.name}</h1>
                              ...
                              <div className={openTab === index ? 'block' : 'hidden'} id={index}>
                                ...
                                <div className='mb-6'>
                                  <div className='relative mt-6'>
                                    <DatePicker
                                      range
                                      placeholder='Ketersediaan tanggal booking'
                                      style={{
