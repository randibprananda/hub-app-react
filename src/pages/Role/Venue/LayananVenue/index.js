...
const LayananVenue = () => {
    ...
    const [venueSpesifikasiLayanan, setVenueSpesifikasiLayanan] = useState();
    ...
    const AddLayananVenue = async () => {
        ...
        if (error.length > 0) {
            ...
            formData.append("venue_spesification", venueSpesifikasiLayanan);
            ...
            try {
                await Api.createVenue(localStorage.getItem("token-hub"), formData).then(async (response) => {
            ...
            <div className='lg:px-[75px] px-[10px] pt-[120px] pb-[10px] md:pt-[140px] md:pb-[30px]'>
                ...
                <div>
                    <div className='flex items-center gap-3'>
                        <button onClick={() => navigate(-1)} className='text-black-k text-xs lg:text-sm font-[500] hover:text-primary'>Beranda</button>
                        <img src={IconNext} alt='' />
                        <button className='text-black-k text-xs lg:text-sm font-[500] hover:text-primary'>Profil</button>
                    </div>
                    <div className='flex lg:flex-row flex-col gap-[30px] mt-[30px]'>
                        <div className='min-w-[307px] min-h-[219px] max-h-[219px] rounded-[12px] bg-white px-[17px] py-[41px]'>
                            <div className='flex items-center gap-[20px] relative'>
                                <div className={`h-[50px] w-[50px] flex justify-center items-center rounded-full flex-shrink-0 ${stepp === 2 ? 'bg-[#00CDB4]' : 'bg-[#00CDB433]'}  `}>
                                    <h1 className='text-[#00CDB4] font-semibold text-[18px]'>{stepp === 2 ? <span><img src={IconCheckWhite} alt='' /></span> : '1'}</h1>
                                </div>
                                <div>
                                    ...
                                    <div className='flex flex-col'>
                                        ...
                                        <div className='flex flex-col gap-[20px] mb-[52px]'>
                                            <div>
                                                ...
                                                <input type="text" id="first_name" className="mt-[10px] rounded-[12px] outline-none border border-outline-2 w-full md:px-4 md:py-4 bg-white px-[10px] py-[10px] text-fill md:text-sm text-xs font-[500]" placeholder="Ex : Starter" onChange={(e) => setVenueName(e.target.value)} required />
                                            </div>
                                            <div>
                                                <h1 className='md:text-sm text-xs text-dark-5 font-medium'>Deskripsi Layanan <span className='text-red-700'>*</span></h1>
                                                <textarea onChange={(e) => setVenueDescription(e.target.value)} id="message" rows="2" className="rounded-[12px] outline-none border border-outline-2 w-full md:px-4 md:py-4  bg-white px-[10px] py-[10px] text-fill md:text-sm text-xs font-[500]" placeholder="Jelaskan apa yang akan client dapat pada Layanan ini"></textarea>
                                            ...
                                            <div>
                                                ...
                                                <textarea onChange={(e) => setVenueSpesifikasiLayanan(e.target.value)} rows="2" className="rounded-[12px] outline-none border border-outline-2 w-full md:px-4 md:py-4  bg-white px-[10px] py-[10px] text-fill md:text-sm text-xs font-[500]" placeholder="Tuliskan lebih detail spesifikasi dari layanan anda "></textarea>
                                                <div className='flex justify-between'>
                                                    <h1 className='md:text-xs text-[8px] text-black-6 font-bold'>Minimal 12 karakter</h1>
                                                    <h1 className='md:text-xs text-[8px] text-black-6 font-bold'>0/1200</h1>
                                                </div>
                                            ...
                                            <div>
                                                ...
                                                <div className='flex flex-row  md:space-x-10 space-x-4 mt-[10px]'>
                                                    <div className="">
                                                        <div className="flex items-center justify-center w-full">
                                                            <label htmlFor='upload-foto' className="cursor-pointer">
                                                                ...
                                                                {images.length <= 9 ?
                                                                    <input id='upload-foto' accept="image/*" type="file" multiple onChange={handleFile} className='rounded-[12px] outline-none border border-[#E3E8F1] w-full px-[20px] py-[15px] hidden' />
                                                                    :
                                                                    null
                                                                }
                                                            </label>
                                                    ...
                                                    <ul class="list-disc text-dark-6 text-[10px] md:text-[13px] font-medium py-5 lg:py-0">
                                        ...
                                        <div className='flex justify-end items-end space-x-4'>
                                            ...
                                            <button
                                                onClick={() => {
                                                    !venueName || !venueDescription || !venueSpesifikasiLayanan || !images.length ?
                            ...
                            {stepp === 2 &&
                                <div className='flex flex-col'>
                                                ...
                                                <div key={index}>
                                                    ...
                                                    <div className='w-full p-5 bg-light rounded-[12px]'>
                                                        ...
                                                        <div className='space-y-[10px] mb-[10px]'>
                                                            ...
                                                            <div className='flex flex-row items-end justify-between gap-[20px] w-full'>
                                                        ...
                                                        {/* <div className='space-y-[10px] lg:col-span-4 col-span-6 mb-[10px]'>
                                                        ...
                                                        <div className='md:grid md:grid-cols-12 mb-[10px] gap-[20px]'>
                                                            <div className='w-full md:col-span-4'>
                                                                <h1 className='md:text-sm text-xs text-black-k font-medium'>Harga <span className='text-red-700'>*</span></h1>
                                                            ...
                                                            <div className='w-full md:col-span-4'>
                                                                ...
                                                                <input type='text' value={input.package_qty} name='package_qty' onChange={event => handleFormChange(index, event)} className='rounded-[12px] outline-none border border-outline-2 w-full md:px-4 md:py-4  bg-white px-[10px] py-[10px] text-fill md:text-sm text-xs font-[500]' placeholder='Ex. Per Sesi' required />
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div className='md:grid md:grid-cols-12 gap-[20px] mb-[10px]'>
                                                                ...
                                                                </div>
                                                                {
                                                                    input.package_disc_type === 'Persentase' && (
                                                                        <div className='space-y-[10px] md:col-span-4'>
                                                                            <h1 className='md:text-sm text-xs text-black-k font-medium md:mt-0 mt-3'>Nilai Diskon <span className='text-red-700'>*</span></h1>
                                                                ...
                                                                <div className='space-y-[10px] lg:col-span-4 col-span-6'>
                                                                    <h1 className='md:text-sm text-xs text-black-k font-medium md:mt-0 mt-3'>Harga Tertampil <span className='text-red-700'>*</span></h1>
                                    ...
                                    <div className='flex justify-end items-end space-x-4'>
                                        ...
                                        <button onClick={AddLayananVenue} className='h-auto md:py-3 md:px-6 py-2 px-5 text-sm rounded-md bg-cherry text-white flex items-center justify-center font-[500]'>
                                            {/* Simpan */}
                                            {isLoading ?
